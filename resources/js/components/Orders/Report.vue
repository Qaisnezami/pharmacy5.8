    ...
    <div class="container-fluid" id="report">
        <div v-if="$gate.isPurchaseReport() && $gate.Read()">
            <div class="content-header">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark " v-if="rtl == 'rtl'">{{$t('Report')}} {{$t('Order')}} </h1>
                        <h1 class="m-0 text-dark " v-else>{{$t('Order')}} {{$t('Report')}}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card border-0 rounded-0">
                        ...
                        <div class="card-body">
                            ...
                            <h1 id="counterSaleTitle"  class="text-center d-none" v-if="rtl == 'rtl'">{{$t('Report')}} {{$t('Order')}}</h1>  
                            <h1 id="counterSaleTitle"  class="text-center d-none" v-else>{{$t('Order')}} {{$t('Report')}}</h1>  
                            ...
                            <tbody>
                                <tr v-for="(order,i) in list" :key="i"  >
                                    ...
                                    <td v-if="order.is_stock">Yes</td>
                                    <td v-else>No</td>
                                    <td v-if="order.approve==1" class="text-center" >
                                            <span class="bg-success px-1">{{ $t('Approved')}}</span>
                                    </td>
                                    <td class="text-center" v-else-if="order.approve==2" >
                                    ...
                                    <td class="modeify">
                                        <router-link class="btn" :to="'/order/show/'+order.id"><i class="fa fa-print"></i></router-link>
                                    </td>
                                </tr>
                            </tbody>
